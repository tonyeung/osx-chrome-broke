          ...
          return {
              ...
              link: function ($scope, element, attrs) {
                  ...
                  $scope.quickListDefinitions = [
                    {
                        label: "Last week",
                        range: moment().range(moment().subtract(1, "week").startOf("week").startOf("day"), moment().subtract(1, "week").endOf("week").endOf("day"))
                    }, {
                        label: "This week",
                        ...
                        label: "Last month",
                        range: moment().range(moment().subtract(1, "month").startOf("month").startOf("day"), moment().subtract(1, "month").endOf("month").endOf("day"))
                    }, {
                        label: "This month",
                        ...
                        label: "Last year",
                        range: moment().range(moment().subtract(1, "year").startOf("year").startOf("day"), moment().subtract(1, "year").endOf("year").endOf("day"))
                    }, {
                        label: "This year",
                        range: moment().range(moment().startOf("year").startOf("day"), moment().endOf("year").startOf("day"))
                    }, {
                        label: "Next year",
                        range: moment().range(moment().startOf("year").add(1, "year").startOf("day"), moment().add(1, "year").endOf("year").startOf("day"))
                    }
                  ];
                  $scope.quick = null;
                  $scope.range = null;
                  ...
                  _calculateRange = function () {
                      var end, start;
                      return $scope.range = $scope.selection ? (start = $scope.selection.start.clone().startOf("month").startOf("day"), end = start.clone().add(1, "months").endOf("month").startOf("day"), moment().range(start, end)) : moment().range(moment().startOf("month").subtract(1, "month").startOf("day"), moment().endOf("month").startOf("day"));
                  };
